...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem(text = "Wrapped 2025", tabName = "wrapped")
            ...
            fluidRow(style = "padding-bottom: 20px; padding-top: 20px;",
                     ...
                     box(width = 10,
                         ...
                         fluidRow(
                           ...
                           # title
                           div(style = "font-family: Bowlby+One+SC; font-weight: bold; font-size: 30px; text-align: center; margin-top: 10px;",
                           ...
                           column(width = 4,
                                  ...
                                  # key findings
                                  div(style = "display: flex; flex-direction: column; gap: 50px; font-family: Manrope; font-size: 18px;",
                                      
                                      # first place
                                      div(style = "display: flex; align-items: center; gap: 15px;",
                                          div(style = "width: 100px; text-align: center; -webkit-text-stroke: 2px black; color: #D6AF36;", icon("star", class = "fa-solid fa-2x")),
                                          "First Place"),
                                      
                                      # second place
                                      div(style = "display: flex; align-items: center; gap: 15px;",
                                          div(style = "width: 100px; text-align: center; -webkit-text-stroke: 2px black; color: #A7A7AD;", icon("star", class = "fa-solid fa-2x")),
                                          "Second Place"),
                                      
                                      # third place
                                      div(style = "display: flex; align-items: center; gap: 15px;",
                                          div(style = "width: 100px; text-align: center; -webkit-text-stroke: 2px black; color: #A77044;", icon("star", class = "fa-solid fa-2x")),
                                          "Third Place"),
                                      
                                      # last place
                                      div(style = "display: flex; align-items: center; gap: 15px;",
                                          div(style = "width: 100px; text-align: center; color: red;", icon("circle", class = "fa-2x")),
                                          "Last Place")),
                           ...
                           column(width = 8,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "monthly_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
                         ...
                         fluidRow(
                           ...
                           column(width = 5,
                                  ...
                                  div(style = "text-align: center;",
                                      img(src = "images/charli.jpeg", height = "250px", style = "border-radius: 10px;"))
                           ...
                           column(width = 7,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "artists_10_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
                     ...
                     box(width = 10,
                         ...
                         fluidRow(
                           ...
                           column(width = 6,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "artists_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
                     ...
                     box(width = 10,
                         ...
                         fluidRow(
                           ...
                           column(width = 6,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "songs_10_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
                     ...
                     box(width = 10,
                         ...
                         fluidRow(
                           ...
                           column(width = 6,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "sots_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
                     ...
                     box(width = 10,
                         ...
                         fluidRow(
                           ...
                           column(width = 6,
                                  ...
                                  # monthly streams
                                  plotOutput(outputId = "streaming_output") %>%
                                    withSpinner(color = "black", type = 1, size = 1)
